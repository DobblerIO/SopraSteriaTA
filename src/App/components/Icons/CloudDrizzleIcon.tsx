...
export const CloudDrizzleIcon: FC = () => {
    return (
        <IconWrapper>
            <svg version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 100 100" enableBackground="new 0 0 100 100" >
                <path fill="#FFFFFF" fillRule="evenodd" clipRule="evenodd" d="M63.943,64.941v-4.381c2.387-1.385,3.998-3.961,3.998-6.92c0-4.418-3.58-8-7.998-8
