...
export const CloudFogIcon: FC = () => {
    return (
        <IconWrapper>
            <svg version="1.1" id="Layer_1" x="0px" y="0px"
                viewBox="0 0 100 100" enableBackground="new 0 0 100 100" >
                <path fill="#FFFFFF" fillRule="evenodd" clipRule="evenodd" d="M69.998,65.641H30.003c-1.104,0-2-0.896-2-2c0-1.105,0.896-2,2-2h39.995
